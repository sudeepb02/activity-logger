...
type Activity struct {
	...
	Type      string `protobuf:"bytes,2,opt,name=type,proto3" json:"type,omitempty"`            //Activity Type
	Timestamp int64  `protobuf:"varint,3,opt,name=timestamp,proto3" json:"timestamp,omitempty"` //Timestamp in Unix epoch time
	Duration  int64  `protobuf:"varint,4,opt,name=duration,proto3" json:"duration,omitempty"`   //Duration in seconds
	Label     string `protobuf:"bytes,5,opt,name=label,proto3" json:"label,omitempty"`          //Activity Label
}
...
type IsValidResponse struct {
	...
	Result bool `protobuf:"varint,1,opt,name=result,proto3" json:"result,omitempty"` //Returns if activity is valid
}
...
var file_activitypb_activity_proto_rawDesc = []byte{
	...
	0x69, 0x76, 0x69, 0x74, 0x79, 0x22, 0x7e, 0x0a, 0x08, 0x41, 0x63, 0x74, 0x69, 0x76, 0x69, 0x74,
	...
	0x6c, 0x74, 0x22, 0x1f, 0x0a, 0x0d, 0x49, 0x73, 0x44, 0x6f, 0x6e, 0x65, 0x52, 0x65, 0x71, 0x75,
	0x65, 0x73, 0x74, 0x12, 0x0e, 0x0a, 0x02, 0x69, 0x64, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52,
	0x02, 0x69, 0x64, 0x22, 0x28, 0x0a, 0x0e, 0x49, 0x73, 0x44, 0x6f, 0x6e, 0x65, 0x52, 0x65, 0x73,
	0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x16, 0x0a, 0x06, 0x73, 0x74, 0x61, 0x74, 0x75, 0x73, 0x18,
	0x01, 0x20, 0x01, 0x28, 0x08, 0x52, 0x06, 0x73, 0x74, 0x61, 0x74, 0x75, 0x73, 0x22, 0x20, 0x0a,
	...
	0x01, 0x28, 0x09, 0x52, 0x06, 0x72, 0x65, 0x73, 0x75, 0x6c, 0x74, 0x22, 0x20, 0x0a, 0x0e, 0x47,
	...
	0x2e, 0x61, 0x63, 0x74, 0x69, 0x76, 0x69, 0x74, 0x79, 0x2e, 0x55, 0x73, 0x65, 0x72, 0x52, 0x04,
	0x75, 0x73, 0x65, 0x72, 0x22, 0x24, 0x0a, 0x12, 0x47, 0x65, 0x74, 0x41, 0x63, 0x74, 0x69, 0x76,
	...
	0x79, 0x22, 0x47, 0x0a, 0x15, 0x55, 0x70, 0x64, 0x61, 0x74, 0x65, 0x41, 0x63, 0x74, 0x69, 0x76,
	0x69, 0x74, 0x79, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x2e, 0x0a, 0x08, 0x61, 0x63,
	...
	0x52, 0x08, 0x61, 0x63, 0x74, 0x69, 0x76, 0x69, 0x74, 0x79, 0x22, 0x48, 0x0a, 0x16, 0x55, 0x70,
	...
	0x76, 0x69, 0x74, 0x79, 0x32, 0xfb, 0x03, 0x0a, 0x0f, 0x41, 0x63, 0x74, 0x69, 0x76, 0x69, 0x74,
	0x79, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x12, 0x4a, 0x0a, 0x0b, 0x4c, 0x6f, 0x67, 0x41,
	0x63, 0x74, 0x69, 0x76, 0x69, 0x74, 0x79, 0x12, 0x1c, 0x2e, 0x61, 0x63, 0x74, 0x69, 0x76, 0x69,
	0x74, 0x79, 0x2e, 0x4c, 0x6f, 0x67, 0x41, 0x63, 0x74, 0x69, 0x76, 0x69, 0x74, 0x79, 0x52, 0x65,
	...
	,
...
var file_activitypb_activity_proto_depIdxs = []int32{
	...
	1,  // 1: activity.AddUserRequest.user:type_name -> activity.User
	1,  // 2: activity.GetUserResponse.user:type_name -> activity.User
	0,  // 3: activity.GetActivityResponse.activity:type_name -> activity.Activity
	0,  // 4: activity.UpdateActivityRequest.activity:type_name -> activity.Activity
	0,  // 5: activity.UpdateActivityResponse.activity:type_name -> activity.Activity
	2,  // 6: activity.ActivityService.LogActivity:input_type -> activity.LogActivityRequest
	8,  // 7: activity.ActivityService.AddUser:input_type -> activity.AddUserRequest
	10, // 8: activity.ActivityService.GetUser:input_type -> activity.GetUserRequest
	12, // 9: activity.ActivityService.GetActivity:input_type -> activity.GetActivityRequest
	14, // 10: activity.ActivityService.UpdateActivity:input_type -> activity.UpdateActivityRequest
	4,  // 11: activity.ActivityService.IsDone:input_type -> activity.IsDoneRequest
	6,  // 12: activity.ActivityService.IsValid:input_type -> activity.IsValidRequest
	3,  // 13: activity.ActivityService.LogActivity:output_type -> activity.LogActivityResponse
	9,  // 14: activity.ActivityService.AddUser:output_type -> activity.AddUserResponse
	11, // 15: activity.ActivityService.GetUser:output_type -> activity.GetUserResponse
	13, // 16: activity.ActivityService.GetActivity:output_type -> activity.GetActivityResponse
	15, // 17: activity.ActivityService.UpdateActivity:output_type -> activity.UpdateActivityResponse
	5,  // 18: activity.ActivityService.IsDone:output_type -> activity.IsDoneResponse
	7,  // 19: activity.ActivityService.IsValid:output_type -> activity.IsValidResponse
